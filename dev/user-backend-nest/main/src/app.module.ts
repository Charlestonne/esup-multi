...
@Module({
  imports: [
    ...
    ClientsModule.registerAsync([
      ...
      {
        name: 'CARD_SERVICE',
        imports: [ConfigModule.forFeature(microserviceCardConfig)],
        useFactory: (config: ConfigService) => config.get('microservice-card'),
        inject: [ConfigService],
      },
      {
      ...
      {
        name: 'EVENTS_SERVICE',
        imports: [ConfigModule.forFeature(microserviceEventsConfig)],
        useFactory: (config: ConfigService) =>
          config.get('microservice-events'),
        inject: [ConfigService],
      },
    ]),
    PassportModule,
